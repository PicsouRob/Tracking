    ...
    return (
        <div class="relative flex flex-col md:flex-row max-w-7xl px-8 py-10 gap-12 mb-16 z-10 items-center justify-center mx-auto">
            <div class="w-full md:w-1/2 flex items-start flex-col">
                ...
                <p class="py-4 text-xl tracking-wide leading-relaxed text-gray-300">Praesent tristique magma sit amet purus gravida quis blandit turpis.<br /> Enim nunc faucibus a pellentesque sit amet portitor eget. Enim lobortis scelerisque fermentum dui.</p>
