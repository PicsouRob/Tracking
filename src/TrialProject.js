    ...
    return (
        <div class="relative flex flex-col md:flex-row max-w-7xl px-8 py-10 gap-12 mb-16 z-10 items-center">
            <div class="w-full md:w-1/2 flex items-start flex-col">
                ...
                <p class="py-4 text-gray-300 leading-normal text-xl">Praesent tristique magma sit amet purus gravida quis blandit turpis.<br /> Enim nunc faucibus a pellentesque sit amet portitor eget. Enim lobortis scelerisque fermentum dui.</p>
